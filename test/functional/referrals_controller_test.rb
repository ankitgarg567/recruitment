...
class ReferralsControllerTest < ActionController::TestCase
  ...
  test "should create referral" do
    assert_difference('Referral.count') do
      post :create, referral: { email: @referral.email, name: @referral.name, referredby: @referral.referredby, role: @referral.role, technology: @referral.technology }
    end
  ...
  test "should update referral" do
    put :update, id: @referral, referral: { email: @referral.email, name: @referral.name, referredby: @referral.referredby, role: @referral.role, technology: @referral.technology }
    assert_redirected_to referral_path(assigns(:referral))
  end
